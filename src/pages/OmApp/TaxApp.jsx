...
const TaxApp = () => {
  return (
    <>
      <ReusableHero
        title="Simplify Tax Management with Our App"
        subText="Experience seamless tax filing and financial planning with our user-friendly and intuitive Tax App."
      />
            ...
            <div className="whtapp__child--main">
              ...
              <div className="whtapp__content">
                ...
                <p>
                  ...
                  the companys account on the app. So, at the point of
