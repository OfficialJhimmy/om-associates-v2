import "./index.css";
import aboutImage from "../../assets/images/image-2.webp";
    ...
    <section className="aboutus__container">
      <div className="aboutus__info">
        ...
        <p className="aboutus__info--smallpara">
          Get help from O.M. Associates, a professional company with advanced
        ...
        <div className="aboutus__info--box">
          ...
          <div className="aboutus__info--box--cover">
            ...
            <p className="aboutus__info--box--cover__para">Satisfied Clients</p>
          </div>
        </div>
      </div>
      <div className="aboutus__imagebox">
        ...
        <div className="aboutus__icon--bottom">
          ...
          <div>
            <p className="aboutus__icon--bottom--total">
              Decades of Collective Experience
            </p>
            <p className="aboutus__icon--bottom--para">
